window.PORTAL_TEMPLATE_CONFIG = {
  ...
  "theme": {
    ...
    "paperStrong": "rgba(255, 252, 248, 0.97)",
    "ink": "#1f1714",
    "muted": "#72615c",
    "line": "rgba(62, 33, 24, 0.12)",
    "lineStrong": "rgba(62, 33, 24, 0.22)",
    "accent": "#c6673f",
    "accentDark": "#8e4227",
    "ok": "#2d8556",
    "warn": "#b77818",
    "fail": "#b6493d",
    "replyExternal": "#7f4e3d",
    "bgTopLeft": "rgba(198, 103, 63, 0.18)",
    "bgRight": "rgba(225, 155, 96, 0.14)",
    "bgStart": "#f1e4d6",
    "bgMid": "#fbf5ee",
    "bgEnd": "#eedecd"
  }
